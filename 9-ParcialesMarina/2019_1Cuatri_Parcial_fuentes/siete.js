function mostrar()
{
    ...
    alert("a) El promedio de las alturas totales es: "+promedioAlturas+"<br> b) La altura más baja es : "+alturaMenor+ " y el sexo de esa persona es: "+sexoMenor+ "<br> c) La cantidad de mujeres que su altura supere los 190 centimetros es "+cantFMas190);
}
