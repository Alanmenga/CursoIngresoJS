function mostrar()
{
    ...
    document.write("a) La cantidad de n�meros pares: " + contadorPares + "</br>");
    document.write("b) La cantidad de n�meros impares: " + contadorImpares + "</br>");
    document.write("c) La cantidad de ceros: " + contadorCeros + "</br>");
    document.write("d) El promedio de todos los n�meros positivos ingresados: " + promedioPos.toFixed(2) + "</br>");
